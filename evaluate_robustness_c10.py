...
def main():
    ...
    test_set = CIFAR10(root=args.data_path, train=False, download=False, transform=transform)
    ...
    names = [
        'Huang2022Revisiting_WRN-A4', 'Sehwag2020Hydra', 'Carmon2019Unlabeled', 'Huang2020Self', 'Rice2020Overfitting', 
        'Bai2024MixedNUTS', 'Chen2020Adversarial', 'Bai2023Improving_edm'
        ]
